    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        push.register(new MFPPushResponseListener<String>() {
            ...
            public void onFailure(MFPPushException ex) {
                ...
                setStatus("Error registering for push notifications: " + ex.getErrorMessage(), false);
                Log.e(TAG, ex.getErrorMessage());
                push = null;
            }
        });
        ...
        notificationListener = new MFPPushNotificationListener() {
            ...
            public void onReceive(final MFPSimplePushNotification message) {
                Log.i(TAG, "Received a Push Notification Payload - Payload " + message.getPayload().toString());
                Log.i(TAG, "Received a Push Notification Payload Alert " + message.getAlert().toString());
                ...
                runOnUiThread(new Runnable() {
                    public void run() {
                        new AlertDialog.Builder(MainActivity.this)
                                .setTitle(" Alert received from " + SensorType)
